...
@csrf
<div class="grid grid-col-2 x-data="{ isUploading: false, progress: 0 }"
...
<button x-bind:disabled="isUploading" class="font-light w-20 text-sm bg-blueline hover:border-2 shadow focus:bg-blue-500 active:bg-blue-500 rounded p-2 text-gray-50 disable:text-site-white disabled:bg-site-gray" type="submit">save </button>
</div>
</div>
</div>
</form>
