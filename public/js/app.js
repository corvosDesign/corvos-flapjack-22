...
window.anime = animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_1__["default"];
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var svgWidth = svgRect.width; //adds a group, circle, and text to background svg to be animated
  ...
  function addCir(svgPaths) {
    ...
    Yellowcircle.setAttributeNS(null, "fill", "url(#grad1)"); // group.appendChild(Yellowcircle);
  ...
  function randomX() {
    var rx = Math.floor(Math.random() * svgWidth + 1);
    return rx;
  }

  function randomY() {
    var ry = Math.floor(Math.random() * svgHeight + 1);
    return ry;
  }

  function randonR() {
    var svgR = Math.floor(Math.random() * 20 + 6);
    return svgR;
